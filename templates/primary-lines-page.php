...
<?php $arg = array(
    ...
    <div class="container archive-category">
        <div class="row">
            ...
            if ($the_query->have_posts()) : ?>
                ...
                <div class="col-md-8 col-sm-12">
                  <div class="spillwrapper" style="display: block; height: 733px; overflow: hidden;">
        ...
        <div class="morepanel" style="display: block; margin: 0 auto; width: 100%; padding-bottom: 20px; padding-top: 65px;">
            <button style="display: block; margin: 0 auto;" class="btn-primary" id="show_hide_minutes">View More Primary Lines</button>
        </div>
    </div>
                </div>
            <?php endif; ?>
